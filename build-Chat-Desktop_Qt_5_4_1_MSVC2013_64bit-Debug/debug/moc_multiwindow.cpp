...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_MultiWindow_t, stringdata) + ofs \
...
const QMetaObject MultiWindow::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_MultiWindow.data,
      qt_meta_data_MultiWindow,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *MultiWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_MultiWindow.stringdata))
        return static_cast<void*>(const_cast< MultiWindow*>(this));
